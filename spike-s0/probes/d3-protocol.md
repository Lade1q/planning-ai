...
- *(bổ sung sau research 16/08 nếu có model live mới hơn — amendment ghi ở cuối tệp, KHÔNG đổi ngưỡng)*
...
- **D3-FC:** cả `gemini-3.1-flash-live-preview` lẫn `gemini-2.5-flash-native-audio-latest` ra **nhánh A**
  ...
  **nói 12 chunk và đóng turn TRƯỚC khi tool-response (trì hoãn 3s) được gửi** — trái nguyên văn docs
  live-tools (06/2026) *"The model will not start responding until you've sent the tool response"*.
