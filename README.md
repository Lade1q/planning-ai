...
- `/docs`: Thư mục chứa tài liệu thiết kế, phân tích, kiểm thử và quản lý dự án.
  ...
  - `/docs/analysis and design/`: Tài liệu thiết kế hệ thống, UML, UI design.
  ...
  - `/docs/research/`: Tài liệu nghiên cứu công nghệ và phân tích đối thủ cạnh tranh.
- `/pa`: Thư mục chứa các bài tập dự án đã nộp.
