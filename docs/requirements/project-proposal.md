...
> [!NOTE]
> **Phân tích phân công:** Nhóm có 5 thành viên với sự phân bố vai trò hợp lý. Tuy nhiên, cần làm rõ trách nhiệm cụ thể hơn ở mục 8.
...
- **Plan (Lập kế hoạch):** AI phân tích thông tin đầu vào và tạo kế hoạch hành động có cấu trúc.
- **Focus (Tập trung):** Hỗ trợ phiên làm việc tập trung theo phương pháp Pomodoro, gắn liền với nhiệm vụ cụ thể.
- **Verify (Xác nhận):** AI đóng vai trò người kiểm tra kiến thức, đánh giá mức độ hiểu bài hoặc hoàn thành công việc.
...
| Người tự học            | Tự định hướng việc học, không có người hướng dẫn thường xuyên             | Lập kế hoạch, tự đánh giá mức độ hiểu biết      |

### 3.2. Môi trường hoạt động

- **Loại ứng dụng:** Web Application (Responsive)
- **Trình duyệt hỗ trợ:** Chrome, Edge, Firefox, Safari (các phiên bản mới nhất)
- **Thiết bị:** Desktop, Tablet, Mobile (ưu tiên Desktop cho MVP)

> [!NOTE]
> **Phương án lựa chọn - Phạm vi thiết bị:**
>
> | Phương án       | Mô tả                            | Ưu điểm                                      | Nhược điểm                                 |
> | --------------- | -------------------------------- | --------------------------------------------- | ------------------------------------------ |
> | A (Khuyến nghị) | Web Responsive (ưu tiên Desktop) | Phù hợp thời gian, dễ phát triển và kiểm thử | Trải nghiệm mobile chưa tối ưu             |
> | B               | Web + Mobile App (React Native)  | Trải nghiệm toàn diện                        | Vượt quá khả năng thực hiện trong 5 sprint |
>
> **Đề xuất:** Phương án A. Tập trung web responsive, đảm bảo chất lượng core features trước.
...
**Chi tiết chức năng:**
- Nhập mục tiêu dạng văn bản tự do hoặc có cấu trúc
- AI phân tích và tạo danh sách các bước thực hiện (action items)
- Tự động chia nhỏ nhiệm vụ lớn thành các task nhỏ hơn
- Đề xuất mức độ ưu tiên và thứ tự thực hiện
- Theo dõi tiến độ hoàn thành từng task
...
**Chi tiết chức năng:**
- Tạo phiên tập trung với thời gian tùy chỉnh (mặc định 25 phút làm / 5 phút nghỉ)
- Gắn phiên với một nhiệm vụ cụ thể từ kế hoạch
- Đếm ngược thời gian với giao diện tối giản, hạn chế phân tâm
- Lưu lịch sử các phiên tập trung (ngày, thời lượng, task gắn)
- Hiển thị thống kê tổng hợp (tổng thời gian tập trung theo ngày/tuần)

### 4.3. Tính năng 3: AI Oral Examiner

**Mô tả:** AI đóng vai trò người kiểm tra kiến thức. Đặt câu hỏi dựa trên chủ đề hoặc tài liệu người dùng cung cấp, đánh giá câu trả lời và phản hồi.

**Chi tiết chức năng:**
- Người dùng chọn chủ đề hoặc tải lên tài liệu (văn bản)
- AI tạo câu hỏi dựa trên nội dung được cung cấp
- Người dùng trả lời bằng văn bản
- AI đánh giá câu trả lời: điểm mạnh, điểm yếu, mức độ hiểu bài
- Đề xuất nội dung cần ôn tập tiếp theo
- Lưu lịch sử các phiên kiểm tra và kết quả
...
- Tổng hợp kết quả Oral Exam (xu hướng tiến bộ)
...
- Trang cài đặt (tùy chọn giao diện, thời gian Pomodoro mặc định)
...
### 5.2. Bộ câu hỏi phỏng vấn gợi ý
...
5. Bạn có muốn một AI giúp bạn kiểm tra mức độ hiểu bài sau khi học không? Tại sao? (Verify need)
...
## 6. Danh sách màn hình dự kiến (Quy mô hệ thống)

| STT | Màn hình               | Nhóm tính năng   | Độ ưu tiên (MVP) | Ghi chú                               |
| --- | ---------------------- | ----------------- | ----------------- | -------------------------------------- |
| 1   | Landing Page           | Marketing         | Cao               | Giới thiệu sản phẩm, CTA đăng ký      |
| 2   | Login                  | Authentication    | Cao               | Đăng nhập bằng email/mật khẩu         |
| 3   | Register               | Authentication    | Cao               | Đăng ký tài khoản mới                 |
| 4   | Dashboard              | Dashboard         | Cao               | Tổng quan hoạt động                    |
| 5   | Create Plan            | AI Planning       | Cao               | Nhập mục tiêu, AI tạo kế hoạch        |
| 6   | Plan Details           | AI Planning       | Cao               | Xem chi tiết kế hoạch + task list     |
| 7   | Task Management        | AI Planning       | Cao               | Quản lý, chỉnh sửa, đánh dấu task    |
| 8   | Focus Session          | Focus             | Cao               | Giao diện Pomodoro timer              |
| 9   | Focus History          | Focus             | Trung bình        | Lịch sử các phiên tập trung           |
| 10  | AI Oral Examiner Setup | Verify            | Cao               | Chọn chủ đề, tải tài liệu            |
| 11  | AI Oral Exam Session   | Verify            | Cao               | Giao diện hỏi-đáp với AI             |
| 12  | Oral Exam Result       | Verify            | Cao               | Kết quả đánh giá + đề xuất ôn tập    |
| 13  | User Profile           | Account           | Trung bình        | Thông tin cá nhân                     |
| 14  | Settings               | Account           | Thấp              | Tùy chọn ứng dụng                    |

**Tổng cộng: 14 màn hình** (nằm trong phạm vi 6-50 màn hình theo yêu cầu đề bài)

> [!NOTE]
> **Phương án lựa chọn - Phạm vi màn hình MVP:**
>
> | Phương án       | Số màn hình                       | Mô tả                   | Ưu điểm                                | Nhược điểm                |
> | --------------- | --------------------------------- | ----------------------- | --------------------------------------- | ------------------------- |
> | A (Khuyến nghị) | 12 (bỏ Settings, Focus History)   | Tập trung vào core flow | Khả thi trong 5 sprint, chất lượng cao  | Thiếu một số tiện ích phụ |
> | B               | 14 (đầy đủ)                       | Đầy đủ tính năng        | Trải nghiệm toàn diện hơn              | Rủi ro không kịp deadline |
>
> **Đề xuất:** Phương án A. Sprint 1-4 tập trung 12 màn hình cốt lõi, Sprint 5 bổ sung Settings và Focus History nếu còn thời gian.
...
- **Lý do:** Miễn phí cho mức sử dụng cơ bản, hỗ trợ tiếng Việt tốt, API đơn giản
- **Phương án dự phòng:** OpenAI API (GPT), nhưng có chi phí

### 7.6. Version Control và Collaboration

- **Source Control:** Git + GitHub (đã thiết lập)
- **Project Management:** JIRA (theo yêu cầu môn học)
- **Design:** Figma
...
| Soạn đề xuất dự án          | Kiệt (PM)      | Đang làm      |
...
- Tự đánh giá mức độ hiểu biết hiệu quả với AI Oral Examiner
...
3. **Giả thuyết 3:** Người dùng đánh giá cao việc nhận phản hồi ngay sau khi học tập (-> AI Oral Examiner)

**Phạm vi MVP:**
- 3 tính năng cốt lõi: AI Planning, Focus Session, AI Oral Examiner
- Dashboard tổng hợp
- Hệ thống Authentication cơ bản
- 12 màn hình chính (theo Phương án A ở mục 6)

> [!NOTE]
> **Phương án lựa chọn - Ưu tiên MVP:**
>
> | Phương án       | Ưu tiên                  | Mô tả                                       | Ưu điểm                     | Nhược điểm                          |
> | --------------- | ------------------------ | -------------------------------------------- | ---------------------------- | ------------------------------------ |
> | A (Khuyến nghị) | Plan > Focus > Verify    | Làm tuần tự, mỗi Sprint tập trung 1 feature | Chất lượng cao, dễ kiểm thử  | Verify có thể bị dồn về Sprint cuối |
> | B               | Làm song song 3 features | Chia nhóm: FE+BE làm đồng thời              | Tiến độ nhanh hơn            | Khó tích hợp, rủi ro conflict cao   |
>
> **Đề xuất:** Phương án A. Sprint 2-3 làm AI Planning, Sprint 3-4 làm Focus Session, Sprint 4-5 làm AI Oral Examiner. Dashboard phát triển xuyên suốt.
...
### B. Các câu hỏi cần User xác nhận

1. **Phạm vi thiết bị:** Chọn Phương án A (Web Responsive) hay B (Web + Mobile)?
2. **Số màn hình MVP:** Chọn Phương án A (12 màn hình) hay B (14 màn hình)?
3. **Thứ tự ưu tiên MVP:** Chọn Phương án A (tuần tự Plan > Focus > Verify) hay B (song song)?
4. **Tech stack:** Ý kiến về các phương án Frontend, Backend, Database, Auth đã liệt kê?
5. **Phỏng vấn người dùng:** Nhóm đã bắt đầu phỏng vấn chưa? Cần hỗ trợ gì?

---

> **Ghi chú cuối:** Tài liệu này là bản nháp v1.1, cần User (Leader nhóm) duyệt và bổ sung phần Phỏng vấn người dùng trước khi nộp PA0. Mọi phương án lựa chọn (Options) đều được đánh dấu rõ để User quyết định.
