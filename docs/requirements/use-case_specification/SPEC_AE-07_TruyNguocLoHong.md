...
## 6. Basic Flow
1. **Kích hoạt:** Ngay sau khi hệ thống chấm điểm ở Phiên Kiểm tra (AE-02), nếu khái niệm `C` có `mastery_score` < ngưỡng, SRE tự động kích hoạt tính năng Truy ngược Lỗ hổng.
