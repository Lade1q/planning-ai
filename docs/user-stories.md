...
| ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| **ID**              | US-AUTH-04                                                                                                                                           |
| **User Story**      | Là sinh viên muốn quản lý thông tin cá nhân, tôi muốn xem và cập nhật thông tin hồ sơ cá nhân để tài khoản phản ánh đúng thông tin hiện tại của tôi. |
| **Ưu tiên**         | Thấp                                                                                                                                                 |
...
| ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **ID**              | US-PLAN-02                                                                                                                                                                               |
| **User Story**      | Là sinh viên có lịch cá nhân hay thay đổi đột xuất, tôi muốn chỉnh sửa, sắp xếp lại hoặc xóa các task trong kế hoạch AI tạo ra để kế hoạch phù hợp với lịch thực tế và sở thích của tôi. |
| **Ưu tiên**         | Cao                                                                                                                                                                                      |
...
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **ID**              | US-FOCUS-01                                                                                                                                                                                            |
| **User Story**      | Là sinh viên hay bị xao nhãng, mất tập trung, tôi muốn bắt đầu một phiên học có giới hạn thời gian để làm việc theo các khoảng thời gian có cấu trúc và tránh mất quá nhiều thời gian vào mạng xã hội. |
| **Ưu tiên**         | Trung bình                                                                                                                                                                                             |
...
- [ ] AC1: Sau khi phiên kết thúc, hiển thị màn hình tóm tắt gồm: tổng thời gian học, số lần tạm dừng.
...
#### **3.4.4. US-VERIFY-04 – Lựa chọn chủ đề kiểm chứng thủ công**
...
#### **3.4.5. US-VERIFY-05 – AI phát hiện và lấp lỗ hổng kiến thức nền tảng**
...
| US-VERIFY-04 | Verify        | Chọn chủ đề kiểm chứng thủ công | Trung bình |
| US-VERIFY-05 | Verify        | Phát hiện lỗ hổng kiến thức nền | Cao        |
